...
\frametitle{Background Shape: $\bm{H\rightarrow\gamma\gamma}$ v. $\bm{H\rightarrow\mu\mu$}}
  ...
  \begin{columns}[c]
   \column{60mm}
      \begin{center}
        $H\rightarrow\mu\mu$ \\
        \includegraphics[height=50mm]{2013-10-04SystematicBiasStudy1/order_Shape_Jets01PassPtG10BB_SumPow2}
      \end{center}
   \column{60mm}
      \begin{center}
        $H\rightarrow\gamma\gamma$ AN-13-008 \\
        \includegraphics[height=40mm]{2013-10-04SystematicBiasStudy1/truth_hgg_8TeV_2013moriond_cic0_1Pow}
      \end{center}
  \end{columns}
  \begin{center}
    \bf
...
\frametitle{Limited Fit Range}
  \begin{itemize}
    ...
    \begin{itemize}
      \item Results in 4th-Order Bernsteins for All High Stats Categories
    \end{itemize}
